 ...
 * <p>
 * If you already have an <b>instance</b>, please use {@link RefObject}, this class
 * is used to create new instances with reflection.
 * <p>
 * Even though Java's reflection allows accessing non-accessible constructors,
 * methods and fields, SkyUtils will <b>never</b> add support to access them.
...
public class RefClass {
	 ...
	 * @since SkyUtils 1.0.0
	 */
	public RefClass(@NotNull Class<?> clazz) {
